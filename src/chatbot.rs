...
pub fn register() -> CreateCommand {
    CreateCommand::new("ai")
        .description("Konverzuj s panem Středou!")
        .add_option(
            CreateCommandOption::new(
                CommandOptionType::String,
                "message",
                "zpráva pro pana Středu",
            )
            .required(true),
        )
}
